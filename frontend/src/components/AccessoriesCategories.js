...
class AccessoriesCategories extends Component {
    render() {
        return (
            <div>
                <section>
                    <div className="container-fluid text-center" id="AccessoriesCategories">
                        <div className="row justify-content-center">
                            <div className="col-md-4 col-xs-12 categories" id="guitarCategoryInstrument">
                                <Link to="/GuitarList" className="linksToLists">
                                    ...
                                    <div className="card-body">
                                        <p className="card-text">View Available List of Guitar Accessories</p>
                                    </div>
                                </Link>
                            </div>
                            ...
                            <div className="col-md-4 col-xs-12 categories" id="pianoCategoryInstrument">
                                <Link to="/PianoList" className="linksToLists">
                                    ...
                                    <div className="card-body">
                                        <p className="card-text">View Available List of Piano Accessories</p>
                                    </div>
                                </Link>
                            </div>
                            ...
                            <div className="col-md-4 col-xs-12 categories" id="drumCategoryInstrument">
                                <Link to="/DrumsList" className="linksToLists">
                                    ...
                                    <div className="card-body">
                                        <p className="card-text">View Available List of Drum Accessories</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
